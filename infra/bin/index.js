...
exports.metadata = exports.endpoints = void 0;
const aws = require("@pulumi/aws");
const pulumi = require("@pulumi/pulumi");
// Configuration
const config = new pulumi.Config();
const domainName = config.get('domainName') || 'framv.com';
const subdomains = config.getObject('subdomains') || ['docs', 'slides'];
// Common Tags
const commonTags = {
    Project: 'Framv',
...
const certificate = new aws.acm.Certificate('framv-cert', {
...
const certValidationRecords = certificate.domainValidationOptions.apply((options) => options.map((option) => new aws.route53.Record(`cert-validation-${option.domainName}`, {
...
const certValidation = new aws.acm.CertificateValidation('framv-cert-validation', {
 ...
 */
function createStaticWebsite(name, fqdn, certArn) {
...
// Create for framv.com (Apex)
const mainSite = createStaticWebsite('framv', domainName, certValidation.certificateArn);
// Create for docs.framv.com and slides.framv.com
