import { isPlatformBrowser } from "./chunk-52XYEKUW.js";
import { HttpClient } from "./chunk-77CHUZ7X.js";
import { __spreadProps, __spreadValues } from "./chunk-GOMI4DH3.js";
import { DomSanitizer } from "./chunk-LE46SAHH.js";
import "./chunk-UIFJDWUA.js";
import {
  ...
  constructor() {
    ...
    this.copied = toSignal(
      this._buttonClick$.pipe(
        switchMap(() => merge(of(true), timer(3e3).pipe(mapTo(false)))),
        distinctUntilChanged(),
        shareReplay(1)
      )
    );
