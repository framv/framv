      ...
      <div class="container mx-auto font-mono">
        <div class="grid md:grid-cols-4 gap-8 mb-8">
          <div class="col-span-2">
            ...
            <p class="text-white/60 mb-4 text-xs leading-relaxed">// Freeze HTML elements, animations, and CSS<br />// variables into video frames.</p>
            <div class="flex space-x-3">
              <a href="https://github.com/mensreversa/framv" target="_blank" rel="noopener" class="text-white/60 hover:text-white transition border border-white/10 p-2 hover:border-white/20">
                <span class="block">
          ...
          <div>
            ...
            <ul class="space-y-2">
              ...
              <li>
                <a href="https://docs.framv.com" target="_blank" rel="noopener" class="text-white/40 hover:text-white transition text-xs">&gt; DOCUMENTATION</a>
              </li>
              <li>
                <a href="https://github.com/mensreversa/framv" target="_blank" rel="noopener" class="text-white/40 hover:text-white transition text-xs">&gt; GITHUB</a>
              </li>
            </ul>
          </div>
        ...
        <div class="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between">
          ...
          <div class="flex items-center space-x-4 text-xs text-white/40 uppercase tracking-wider">
            <a href="https://github.com/mensreversa/framv/blob/main/LICENSE" target="_blank" rel="noopener" class="hover:text-white transition">[LICENSE]</a>
            <a href="https://github.com/mensreversa/framv/security" target="_blank" rel="noopener" class="hover:text-white transition">[SECURITY]</a>
          </div>
        </div>
      </div>
    </footer>
